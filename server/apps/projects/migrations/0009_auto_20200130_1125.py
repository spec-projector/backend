    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', bitfield.models.BitField((('FRONTEND_DEVELOPER', 'CH__FRONTEND_DEVELOPER'), ('BACKEND_DEVELOPER', 'CH__BACKEND_DEVELOPER'), ('PROJECT_MANAGER', 'CH__PROJECT_MANAGER'), ('DESIGNER', 'CH__DESIGNER'), ('TESTER', 'CH__TESTER'), ('CUSTOMER', 'CH__CUSTOMER')), default=0)),
