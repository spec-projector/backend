    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='HT__NAME', max_length=150, null=True, unique=True, verbose_name='VN__NAME')),
                ('email', models.EmailField(blank=True, help_text='HT__EMAIL', max_length=150, null=True, unique=True, verbose_name='VN__EMAIL')),
