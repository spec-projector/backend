...
SOCIAL_AUTH_REDIRECT_URI = "https://{0}/login".format(
    DOMAIN_NAME,
)
...
SOCIAL_AUTH_GITLAB_REDIRECT_URI = SOCIAL_AUTH_REDIRECT_URI
...
SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URI = SOCIAL_AUTH_REDIRECT_URI
